...
input_dataset_path = r'D:\mehrs\VScode(projects)\miniProject\DataSets\ChilliDataset(afterAug)'

# Output dataset path (renamed images)
output_dataset_path = r'D:\mehrs\VScode(projects)\miniProject\DataSets\ChilliDataset(afterRename)'
