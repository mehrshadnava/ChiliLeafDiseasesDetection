...
def crop_and_resize_image(image_path, output_path, output_size=(256, 256)):
    ...
    if contours:
        ...
        canvas = np.ones((output_size[1], output_size[0], 3), dtype=np.uint8)   # White canvas
...
input_folder = r'D:\mehrs\VScode(projects)\miniProject\ImageCrop\ChilliDataset11'
output_folder = r'D:\mehrs\VScode(projects)\miniProject\ImageCrop\ChilliDataset22'
